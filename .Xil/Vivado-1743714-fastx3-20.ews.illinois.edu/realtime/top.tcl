...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-1743714-fastx3-20.ews.illinois.edu/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog /tmp/bufr_test.v
      rt::filesetChecksum
    }
...
# MODE: 
    rt::set_parameter webTalkPath {./.Xil/Vivado-1743714-fastx3-20.ews.illinois.edu/wt}
    rt::set_parameter synthDebugLog false
    rt::set_parameter printModuleName false
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-1743714-fastx3-20.ews.illinois.edu/"
